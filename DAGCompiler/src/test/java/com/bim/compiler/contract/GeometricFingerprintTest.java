...
class GeometricFingerprintTest {
    ...
    private static final String[][] ALL_BUILDINGS = {
        ...
        {"IP",  "DAGCompiler/lib/input/Infra_Plumbing_extracted.db",        "DAGCompiler/lib/output/infra_plumbing.db"},
        {"BA",  "DAGCompiler/lib/input/Building_Architecture_extracted.db",  "DAGCompiler/lib/output/building_architecture.db"},
        {"BH",  "DAGCompiler/lib/input/Building_Hvac_extracted.db",         "DAGCompiler/lib/output/building_hvac.db"},
        {"BS",  "DAGCompiler/lib/input/Building_Structural_extracted.db",    "DAGCompiler/lib/output/building_structural.db"},
        {"SC",  "DAGCompiler/lib/input/Schependomlaan_extracted.db",        "DAGCompiler/lib/output/schependomlaan.db"},
        {"CA",  "DAGCompiler/lib/input/Clinic_Architecture_extracted.db",    "DAGCompiler/lib/output/clinic_architecture.db"},
        {"CS",  "DAGCompiler/lib/input/Clinic_Structural_extracted.db",      "DAGCompiler/lib/output/clinic_structural.db"},
        {"CH",  "DAGCompiler/lib/input/Clinic_HVAC_extracted.db",           "DAGCompiler/lib/output/clinic_hvac.db"},
        {"CE",  "DAGCompiler/lib/input/Clinic_Electrical_extracted.db",      "DAGCompiler/lib/output/clinic_electrical.db"},
        {"CP",  "DAGCompiler/lib/input/Clinic_Plumbing_extracted.db",       "DAGCompiler/lib/output/clinic_plumbing.db"},
        {"ES",  "DAGCompiler/lib/input/Esplanades_extracted.db",            "DAGCompiler/lib/output/esplanades.db"},
        {"MO",  "DAGCompiler/lib/input/Molio_extracted.db",                 "DAGCompiler/lib/output/molio.db"},
        {"GH",  "DAGCompiler/lib/input/AC9_HausGH_extracted.db",           "DAGCompiler/lib/output/ac9_hausgh.db"},
        {"NI",  "DAGCompiler/lib/input/AC90_Niedriha_extracted.db",         "DAGCompiler/lib/output/ac90_niedriha.db"},
        {"JE",  "DAGCompiler/lib/input/Jesse_extracted.db",                 "DAGCompiler/lib/output/jesse.db"},
        {"WI",  "DAGCompiler/lib/input/Wilfer_extracted.db",                "DAGCompiler/lib/output/wilfer.db"},
        {"JS",  "DAGCompiler/lib/input/AC90_Jasmin_extracted.db",           "DAGCompiler/lib/output/ac90_jasmin.db"},
        {"WB",  "DAGCompiler/lib/input/BimWhale_Basic_extracted.db",        "DAGCompiler/lib/output/bimwhale_basic.db"},
        {"WL",  "DAGCompiler/lib/input/BimWhale_Large_extracted.db",        "DAGCompiler/lib/output/bimwhale_large.db"},
