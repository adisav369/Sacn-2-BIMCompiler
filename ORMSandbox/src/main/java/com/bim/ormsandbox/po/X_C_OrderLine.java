 ...
 * height_mm, orientation) have been <b>removed</b>. They belong in W_Verb_Node
 * + W_Verb_NodeProduct. If your code needs placement data, use those tables.
 *
 ...
 * @see <a href="docs/BIM_COBOL.md §15.6">W_Verb_Node DDL</a>
 */
public class X_C_OrderLine extends BasePO {
    ...
    // Placement → W_Verb_Node. Material dims → M_Product.
