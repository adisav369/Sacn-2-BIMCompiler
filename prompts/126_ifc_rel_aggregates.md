...
3. `DAGCompiler/lib/input/Ifc4_SampleHouse_extracted.db` — check what tables exist
...
- Re-extract SH: `rm DAGCompiler/lib/input/Ifc4_SampleHouse_extracted.db && python3 scripts/RosettaStoneExtract.py ...`
