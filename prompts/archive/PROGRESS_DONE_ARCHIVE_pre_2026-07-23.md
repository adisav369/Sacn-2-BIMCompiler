# PROGRESS DONE ARCHIVE — items closed 2026-07-17 through 2026-07-22

Rolled out of `PROGRESS.md`'s Archive section to keep that file under its 80-line budget
(`feedback_memory_links_only.md`-style rule, same discipline applied to PROGRESS.md). Detail lives in
each item's own spec doc — these are the exact lines that were in PROGRESS.md before archiving.
