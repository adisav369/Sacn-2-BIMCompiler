...
-- Source: DAGCompiler/lib/output/revit_arc_enbloc.db
-- Generated: 2026-03-21 09:13
-- ════════════════════════════════════════════════════════
...
-- IfcBuildingElementProxy  Level 1             114  2592.0    2506.0    2726.0    87.0      12995.0 
-- IfcPlate                 Unknown             44   1042.0    990.0     2176.0    803.0     1181.0  
-- IfcFurnishingElement     Level 1             38   1013.0    944.0     789.0     376.0     4025.0  
-- IfcWall                  Level 1             34   7400.0    6181.0    2887.0    1215.0    19663.0 
-- IfcFurnishingElement     Level 1 Living Rm.  28   994.0     1027.0    476.0     588.0     3007.0  
-- IfcWall                  Level 2             28   4305.0    4218.0    4453.0    637.0     15695.0 
-- IfcSlab                  Foundation          20   570.0     570.0     3151.0    300.0     840.0   
-- IfcWindow                Level 1 Living Rm.  16   1112.0    1356.0    2710.0    1112.0    1112.0  
-- IfcFlowTerminal          Level 1             10   1562.0    1573.0    502.0     158.0     3449.0  
-- IfcDoor                  Level 2             8    779.0     778.0     2123.0    665.0     875.0   
-- IfcFlowTerminal          Foundation          8    807.0     1012.0    343.0     762.0     925.0   
-- IfcSlab                  Level 1             8    20203.0   14960.0   275.0     8730.0    33173.0 
-- IfcSlab                  Level 2             7    10985.0   9912.0    1082.0    300.0     23023.0 
-- IfcWindow                Level 2             7    1356.0    1112.0    2710.0    1356.0    1356.0  
-- IfcBuildingElementProxy  Level 1 Living Rm.  6    7849.0    5733.0    2908.0    641.0     21341.0 
-- IfcDoor                  Level 1             6    1053.0    1066.0    2190.0    902.0     1334.0  
...
-- IfcColumn                Level 1             4    1139.0    1102.0    5390.0    178.0     2101.0  
-- IfcSlab                  Level 1 Living Rm.  4    9307.0    9880.0    199.0     6598.0    12017.0 
-- IfcRailing               Unknown             3    2064.0    2680.0    2618.0    1910.0    2370.0  
-- IfcCovering              Level 1             2    14400.0   13018.0   50.0      14400.0   14400.0 
-- IfcCovering              Level 1 Living Rm.  2    11892.0   13033.0   50.0      11892.0   11892.0 
-- IfcFurnishingElement     Level 2             2    1201.0    1319.0    2700.0    1201.0    1201.0  
-- IfcRailing               Level 1 Living Rm.  2    4828.0    3651.0    1347.0    4828.0    4828.0  
-- IfcSlab                  Unknown             2    8936.0    9111.0    319.0     5980.0    11892.0 
-- IfcStair                 Level 1 Living Rm.  2    2965.0    2579.0    542.0     2965.0    2965.0  
...
-- -----------------------  ----------  ---
-- IfcMember                STR         144
-- IfcBuildingElementProxy  ARC         126
-- IfcFurnishingElement     ARC         68 
-- IfcWall                  ARC         64 
-- IfcPlate                 STR         44 
-- IfcSlab                  STR         41 
-- IfcWindow                ARC         25 
-- IfcFlowTerminal          MEP         24 
-- IfcDoor                  ARC         19 
-- IfcRailing               STR         11 
-- IfcColumn                ARC         5  
-- IfcCovering              ARC         4  
-- IfcStair                 ARC         2  
-- IfcStairFlight           STR         2  
-- IfcRoof                  ARC         1  
...
-- Rule: IfcBuildingElementProxy_Level_1 (114 instances, avg 2592.0x2506.0x2726.0 mm)
-- INSERT INTO ad_val_rule (rule_name, ifc_class, check_method, severity, is_active,
--     description, provenance)
-- VALUES ('IfcBuildingElementProxy_Level_1', 'IfcBuildingElementProxy', 'DIMENSION_RANGE', 'WARNING', 1,
--     'IfcBuildingElementProxy on Level 1: 114 instances, avg W=2592.0 D=2506.0 H=2726.0mm',
--     'Revit_ARC');
-- INSERT INTO ad_val_rule_param (ad_val_rule_id, param_name, param_value)
...
-- Rule: IfcFurnishingElement_Level_1 (38 instances, avg 1013.0x944.0x789.0 mm)
-- INSERT INTO ad_val_rule (rule_name, ifc_class, check_method, severity, is_active,
--     description, provenance)
-- VALUES ('IfcFurnishingElement_Level_1', 'IfcFurnishingElement', 'DIMENSION_RANGE', 'WARNING', 1,
--     'IfcFurnishingElement on Level 1: 38 instances, avg W=1013.0 D=944.0 H=789.0mm',
--     'Revit_ARC');
-- INSERT INTO ad_val_rule_param (ad_val_rule_id, param_name, param_value)
...
-- Rule: IfcWall_Level_1 (34 instances, avg 7400.0x6181.0x2887.0 mm)
-- INSERT INTO ad_val_rule (rule_name, ifc_class, check_method, severity, is_active,
--     description, provenance)
-- VALUES ('IfcWall_Level_1', 'IfcWall', 'DIMENSION_RANGE', 'WARNING', 1,
--     'IfcWall on Level 1: 34 instances, avg W=7400.0 D=6181.0 H=2887.0mm',
--     'Revit_ARC');
-- INSERT INTO ad_val_rule_param (ad_val_rule_id, param_name, param_value)
...
-- Rule: IfcFurnishingElement_Level_1_Living_Rm. (28 instances, avg 994.0x1027.0x476.0 mm)
-- INSERT INTO ad_val_rule (rule_name, ifc_class, check_method, severity, is_active,
--     description, provenance)
-- VALUES ('IfcFurnishingElement_Level_1_Living_Rm.', 'IfcFurnishingElement', 'DIMENSION_RANGE', 'WARNING', 1,
--     'IfcFurnishingElement on Level 1 Living Rm.: 28 instances, avg W=994.0 D=1027.0 H=476.0mm',
--     'Revit_ARC');
-- INSERT INTO ad_val_rule_param (ad_val_rule_id, param_name, param_value)
...
-- Rule: IfcWindow_Level_1_Living_Rm. (16 instances, avg 1112.0x1356.0x2710.0 mm)
-- INSERT INTO ad_val_rule (rule_name, ifc_class, check_method, severity, is_active,
--     description, provenance)
-- VALUES ('IfcWindow_Level_1_Living_Rm.', 'IfcWindow', 'DIMENSION_RANGE', 'WARNING', 1,
--     'IfcWindow on Level 1 Living Rm.: 16 instances, avg W=1112.0 D=1356.0 H=2710.0mm',
--     'Revit_ARC');
-- INSERT INTO ad_val_rule_param (ad_val_rule_id, param_name, param_value)
...
-- Rule: IfcFlowTerminal_Level_1 (10 instances, avg 1562.0x1573.0x502.0 mm)
-- INSERT INTO ad_val_rule (rule_name, ifc_class, check_method, severity, is_active,
--     description, provenance)
-- VALUES ('IfcFlowTerminal_Level_1', 'IfcFlowTerminal', 'DIMENSION_RANGE', 'WARNING', 1,
--     'IfcFlowTerminal on Level 1: 10 instances, avg W=1562.0 D=1573.0 H=502.0mm',
--     'Revit_ARC');
-- INSERT INTO ad_val_rule_param (ad_val_rule_id, param_name, param_value)
...
-- Rule: IfcSlab_Level_1 (8 instances, avg 20203.0x14960.0x275.0 mm)
-- INSERT INTO ad_val_rule (rule_name, ifc_class, check_method, severity, is_active,
--     description, provenance)
-- VALUES ('IfcSlab_Level_1', 'IfcSlab', 'DIMENSION_RANGE', 'WARNING', 1,
--     'IfcSlab on Level 1: 8 instances, avg W=20203.0 D=14960.0 H=275.0mm',
--     'Revit_ARC');
-- INSERT INTO ad_val_rule_param (ad_val_rule_id, param_name, param_value)
...
-- Rule: IfcBuildingElementProxy_Level_1_Living_Rm. (6 instances, avg 7849.0x5733.0x2908.0 mm)
-- INSERT INTO ad_val_rule (rule_name, ifc_class, check_method, severity, is_active,
--     description, provenance)
-- VALUES ('IfcBuildingElementProxy_Level_1_Living_Rm.', 'IfcBuildingElementProxy', 'DIMENSION_RANGE', 'WARNING', 1,
--     'IfcBuildingElementProxy on Level 1 Living Rm.: 6 instances, avg W=7849.0 D=5733.0 H=2908.0mm',
--     'Revit_ARC');
-- INSERT INTO ad_val_rule_param (ad_val_rule_id, param_name, param_value)
...
-- Rule: IfcDoor_Level_1 (6 instances, avg 1053.0x1066.0x2190.0 mm)
-- INSERT INTO ad_val_rule (rule_name, ifc_class, check_method, severity, is_active,
--     description, provenance)
-- VALUES ('IfcDoor_Level_1', 'IfcDoor', 'DIMENSION_RANGE', 'WARNING', 1,
--     'IfcDoor on Level 1: 6 instances, avg W=1053.0 D=1066.0 H=2190.0mm',
--     'Revit_ARC');
-- INSERT INTO ad_val_rule_param (ad_val_rule_id, param_name, param_value)
...
-- Rule: IfcColumn_Level_1 (4 instances, avg 1139.0x1102.0x5390.0 mm)
-- INSERT INTO ad_val_rule (rule_name, ifc_class, check_method, severity, is_active,
--     description, provenance)
-- VALUES ('IfcColumn_Level_1', 'IfcColumn', 'DIMENSION_RANGE', 'WARNING', 1,
--     'IfcColumn on Level 1: 4 instances, avg W=1139.0 D=1102.0 H=5390.0mm',
--     'Revit_ARC');
-- INSERT INTO ad_val_rule_param (ad_val_rule_id, param_name, param_value)
-- VALUES (last_insert_rowid(), 'typical_width_mm', '1139.0');
-- INSERT INTO ad_val_rule_param (ad_val_rule_id, param_name, param_value)
-- VALUES (last_insert_rowid(), 'typical_depth_mm', '1102.0');
-- INSERT INTO ad_val_rule_param (ad_val_rule_id, param_name, param_value)
-- VALUES (last_insert_rowid(), 'typical_height_mm', '5390.0');

-- Rule: IfcSlab_Level_1_Living_Rm. (4 instances, avg 9307.0x9880.0x199.0 mm)
-- INSERT INTO ad_val_rule (rule_name, ifc_class, check_method, severity, is_active,
--     description, provenance)
-- VALUES ('IfcSlab_Level_1_Living_Rm.', 'IfcSlab', 'DIMENSION_RANGE', 'WARNING', 1,
--     'IfcSlab on Level 1 Living Rm.: 4 instances, avg W=9307.0 D=9880.0 H=199.0mm',
--     'Revit_ARC');
-- INSERT INTO ad_val_rule_param (ad_val_rule_id, param_name, param_value)
-- VALUES (last_insert_rowid(), 'typical_width_mm', '9307.0');
-- INSERT INTO ad_val_rule_param (ad_val_rule_id, param_name, param_value)
-- VALUES (last_insert_rowid(), 'typical_depth_mm', '9880.0');
-- INSERT INTO ad_val_rule_param (ad_val_rule_id, param_name, param_value)
-- VALUES (last_insert_rowid(), 'typical_height_mm', '199.0');
