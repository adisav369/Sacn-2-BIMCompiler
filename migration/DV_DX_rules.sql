...
-- IfcWall               Level 2  25   1502.0    3137.0    2040.0    54.0      8800.0  
-- IfcWall               Level 1  21   2079.0    3027.0    2704.0    124.0     8800.0  
...
-- IfcWall               T/FDN    7    3836.0    5403.0    1232.0    417.0     8800.0  
...
-- IfcWall               Roof     4    4504.0    8796.0    609.0     417.0     8800.0  
...
-- -----------  ----------------------------------------------------------  ---
-- IfcWall      Basic Wall:Interior - Partition (92mm Stud)                 18 
-- IfcCovering  Compound Ceiling:Gypsum Board                               13 
-- IfcWall      Basic Wall:Exterior - Brick on Block                        12 
-- IfcBeam      Metal - Steel - 345 MPa                                     8  
-- IfcSlab      Floor:Finish Floor - Wood                                   8  
-- IfcWall      Basic Wall:Interior - Furring (38 mm Stud)                  8  
-- IfcSlab      Floor:Finish Floor - Ceramic Tile                           6  
-- IfcWall      Basic Wall:Interior - Furring (152 mm Stud)                 6  
-- IfcWall      Basic Wall:Foundation - Concrete (417mm)                    4  
-- IfcWall      Basic Wall:Party Wall - CMU Residential Unit Dimising Wall  4  
-- IfcWall      Basic Wall:Foundation - Concrete (435mm)                    3  
...
-- IfcWall      Basic Wall:Interior - Plumbing (152mm Stud)                 2  
...
-- Rule: IfcWall_Level_2 (25 instances, avg 1502.0x3137.0x2040.0 mm)
-- INSERT INTO ad_val_rule (rule_name, ifc_class, check_method, severity, is_active,
--     description, provenance)
-- VALUES ('IfcWall_Level_2', 'IfcWall', 'DIMENSION_RANGE', 'WARNING', 1,
--     'IfcWall on Level 2: 25 instances, avg W=1502.0 D=3137.0 H=2040.0mm',
--     'Duplex');
-- INSERT INTO ad_val_rule_param (ad_val_rule_id, param_name, param_value)
-- VALUES (last_insert_rowid(), 'typical_width_mm', '1502.0');
-- INSERT INTO ad_val_rule_param (ad_val_rule_id, param_name, param_value)
-- VALUES (last_insert_rowid(), 'typical_depth_mm', '3137.0');
-- INSERT INTO ad_val_rule_param (ad_val_rule_id, param_name, param_value)
-- VALUES (last_insert_rowid(), 'typical_height_mm', '2040.0');

-- Rule: IfcWall_Level_1 (21 instances, avg 2079.0x3027.0x2704.0 mm)
-- INSERT INTO ad_val_rule (rule_name, ifc_class, check_method, severity, is_active,
--     description, provenance)
-- VALUES ('IfcWall_Level_1', 'IfcWall', 'DIMENSION_RANGE', 'WARNING', 1,
--     'IfcWall on Level 1: 21 instances, avg W=2079.0 D=3027.0 H=2704.0mm',
--     'Duplex');
-- INSERT INTO ad_val_rule_param (ad_val_rule_id, param_name, param_value)
...
-- Rule: IfcWall_T/FDN (7 instances, avg 3836.0x5403.0x1232.0 mm)
-- INSERT INTO ad_val_rule (rule_name, ifc_class, check_method, severity, is_active,
--     description, provenance)
-- VALUES ('IfcWall_T/FDN', 'IfcWall', 'DIMENSION_RANGE', 'WARNING', 1,
--     'IfcWall on T/FDN: 7 instances, avg W=3836.0 D=5403.0 H=1232.0mm',
--     'Duplex');
-- INSERT INTO ad_val_rule_param (ad_val_rule_id, param_name, param_value)
...
-- Rule: IfcWall_Roof (4 instances, avg 4504.0x8796.0x609.0 mm)
-- INSERT INTO ad_val_rule (rule_name, ifc_class, check_method, severity, is_active,
--     description, provenance)
-- VALUES ('IfcWall_Roof', 'IfcWall', 'DIMENSION_RANGE', 'WARNING', 1,
--     'IfcWall on Roof: 4 instances, avg W=4504.0 D=8796.0 H=609.0mm',
--     'Duplex');
-- INSERT INTO ad_val_rule_param (ad_val_rule_id, param_name, param_value)
