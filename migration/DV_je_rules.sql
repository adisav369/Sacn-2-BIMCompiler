...
-- Source: DAGCompiler/lib/output/jesse_enbloc.db
...
-- IfcWall         Level -1            136  2641.0    2473.0    2335.0    100.0     21525.0 
-- IfcWall         Level 1             70   3273.0    2547.0    4153.0    100.0     21350.0 
-- IfcDoor         Level 1             50   830.0     670.0     2243.0    150.0     1982.0  
-- IfcDoor         Level -1            42   1067.0    254.0     2195.0    150.0     1982.0  
-- IfcWall         level 0             34   1421.0    2748.0    3141.0    100.0     12300.0 
-- IfcWall         T.O. level 0 floor  24   3295.0    3005.0    3914.0    100.0     21525.0 
-- IfcWall         T.O. level 1 floor  14   6939.0    5871.0    360.0     250.0     21625.0 
-- IfcDoor         level 0             12   764.0     1054.0    2244.0    150.0     2000.0  
...
-- IfcSlab         level 0             4    11350.0   6298.0    360.0     3400.0    19300.0 
-- IfcDoor         Level 2             3    456.0     761.0     2210.0    150.0     1067.0  
-- IfcSlab         Level -1            2    37300.0   22900.0   360.0     37300.0   37300.0 
-- IfcSlab         Level 1             2    36800.0   20230.0   360.0     36800.0   36800.0 
...
-- Rule: IfcWall_Level_-1 (136 instances, avg 2641.0x2473.0x2335.0 mm)
-- INSERT INTO ad_val_rule (rule_name, ifc_class, check_method, severity, is_active,
--     description, provenance)
-- VALUES ('IfcWall_Level_-1', 'IfcWall', 'DIMENSION_RANGE', 'WARNING', 1,
--     'IfcWall on Level -1: 136 instances, avg W=2641.0 D=2473.0 H=2335.0mm',
--     'Jesse');
-- INSERT INTO ad_val_rule_param (ad_val_rule_id, param_name, param_value)
...
-- Rule: IfcWall_Level_1 (70 instances, avg 3273.0x2547.0x4153.0 mm)
-- INSERT INTO ad_val_rule (rule_name, ifc_class, check_method, severity, is_active,
--     description, provenance)
-- VALUES ('IfcWall_Level_1', 'IfcWall', 'DIMENSION_RANGE', 'WARNING', 1,
--     'IfcWall on Level 1: 70 instances, avg W=3273.0 D=2547.0 H=4153.0mm',
--     'Jesse');
-- INSERT INTO ad_val_rule_param (ad_val_rule_id, param_name, param_value)
...
-- Rule: IfcDoor_Level_1 (50 instances, avg 830.0x670.0x2243.0 mm)
-- INSERT INTO ad_val_rule (rule_name, ifc_class, check_method, severity, is_active,
--     description, provenance)
-- VALUES ('IfcDoor_Level_1', 'IfcDoor', 'DIMENSION_RANGE', 'WARNING', 1,
--     'IfcDoor on Level 1: 50 instances, avg W=830.0 D=670.0 H=2243.0mm',
--     'Jesse');
-- INSERT INTO ad_val_rule_param (ad_val_rule_id, param_name, param_value)
...
-- Rule: IfcDoor_Level_-1 (42 instances, avg 1067.0x254.0x2195.0 mm)
-- INSERT INTO ad_val_rule (rule_name, ifc_class, check_method, severity, is_active,
--     description, provenance)
-- VALUES ('IfcDoor_Level_-1', 'IfcDoor', 'DIMENSION_RANGE', 'WARNING', 1,
--     'IfcDoor on Level -1: 42 instances, avg W=1067.0 D=254.0 H=2195.0mm',
--     'Jesse');
-- INSERT INTO ad_val_rule_param (ad_val_rule_id, param_name, param_value)
...
-- Rule: IfcWall_level_0 (34 instances, avg 1421.0x2748.0x3141.0 mm)
-- INSERT INTO ad_val_rule (rule_name, ifc_class, check_method, severity, is_active,
--     description, provenance)
-- VALUES ('IfcWall_level_0', 'IfcWall', 'DIMENSION_RANGE', 'WARNING', 1,
--     'IfcWall on level 0: 34 instances, avg W=1421.0 D=2748.0 H=3141.0mm',
--     'Jesse');
-- INSERT INTO ad_val_rule_param (ad_val_rule_id, param_name, param_value)
...
-- Rule: IfcWall_T.O._level_1_floor (14 instances, avg 6939.0x5871.0x360.0 mm)
-- INSERT INTO ad_val_rule (rule_name, ifc_class, check_method, severity, is_active,
--     description, provenance)
-- VALUES ('IfcWall_T.O._level_1_floor', 'IfcWall', 'DIMENSION_RANGE', 'WARNING', 1,
--     'IfcWall on T.O. level 1 floor: 14 instances, avg W=6939.0 D=5871.0 H=360.0mm',
--     'Jesse');
-- INSERT INTO ad_val_rule_param (ad_val_rule_id, param_name, param_value)
...
-- Rule: IfcDoor_level_0 (12 instances, avg 764.0x1054.0x2244.0 mm)
-- INSERT INTO ad_val_rule (rule_name, ifc_class, check_method, severity, is_active,
--     description, provenance)
-- VALUES ('IfcDoor_level_0', 'IfcDoor', 'DIMENSION_RANGE', 'WARNING', 1,
--     'IfcDoor on level 0: 12 instances, avg W=764.0 D=1054.0 H=2244.0mm',
--     'Jesse');
-- INSERT INTO ad_val_rule_param (ad_val_rule_id, param_name, param_value)
...
-- Rule: IfcSlab_level_0 (4 instances, avg 11350.0x6298.0x360.0 mm)
-- INSERT INTO ad_val_rule (rule_name, ifc_class, check_method, severity, is_active,
--     description, provenance)
-- VALUES ('IfcSlab_level_0', 'IfcSlab', 'DIMENSION_RANGE', 'WARNING', 1,
--     'IfcSlab on level 0: 4 instances, avg W=11350.0 D=6298.0 H=360.0mm',
--     'Jesse');
-- INSERT INTO ad_val_rule_param (ad_val_rule_id, param_name, param_value)
-- VALUES (last_insert_rowid(), 'typical_width_mm', '11350.0');
-- INSERT INTO ad_val_rule_param (ad_val_rule_id, param_name, param_value)
-- VALUES (last_insert_rowid(), 'typical_depth_mm', '6298.0');
-- INSERT INTO ad_val_rule_param (ad_val_rule_id, param_name, param_value)
-- VALUES (last_insert_rowid(), 'typical_height_mm', '360.0');
