...
public class IFCtoERP {
     ...
     * Patterns mined from SJTII_Terminal (TE) per 00q-B analysis.
    ...
    private static void seedMepPatterns(Connection erpConn) throws SQLException {
        ...
        String[][] patterns = {
            // CW_TERMINAL_01 — Cold Water supply (SJTII_Terminal)
            ...
            {"CW_TERMINAL_01","CW","TERMINAL","40","JUNCTION","FIXTURE","Z","PIPE_STRAIGHT",
             ...
             "SJTII_Terminal"},
            // SP_TERMINAL_01 — Sanitary/Sewage drainage (SJTII_Terminal)
