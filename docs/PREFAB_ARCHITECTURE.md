...
> `W_Verb_Node` (verb invocation = production operation) and `W_Verb_NodeProduct`
...
- **Verb Line** = W_Verb_Node (Production Operation). Each line is a **production step** — HOW to place elements.
