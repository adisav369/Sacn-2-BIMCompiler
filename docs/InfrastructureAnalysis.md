...
| **G3** | DATA_MODEL.md §1.4 | `bom_type = 'BUILDING'` | Infrastructure needs different vocabulary | **RESOLVED** — root identified by tree structure (no parent), not `bom_type` string. Tier selection uses M_Product_Category (S84). See [DISC_VALIDATION_DB_SRS.md §6.5](DISC_VALIDATION_DB_SRS.md#65-the-bom-is-already-perfect) |
...
See also: [`WorkOrderGuide.md`](WorkOrderGuide.md) §Invention Boundary,
