...
**Creator:** [Redhuan D. Oon](mailto:red1org@gmail.com) · Schema first committed [2026-04-11](https://github.com/red1oon/BIMCompiler/commit/f116fdde35eeccbc1d69dc533a89df17bf38a687) (S173 — two-DB split) · This document published 2026-04-29

> **Origin story:** This schema was not designed top-down. It emerged across ~60 collaborative sessions between a BIM domain expert and Claude Code, through a series of constraints that progressively eliminated Blender, .blend files, bake pipelines, and finally Bonsai itself — leaving only two SQLite files and a browser. The full account is in [VibeProgramming.md — The Browser Pivot](VibeProgramming.md#case-study-the-browser-pivot-s165s231).
