...
2. **Warehouse mobile walk** — a phone-first pick / put-away *"walk the aisles"* app over the same
   ...
   fly-to + lens to the next bin, QR scan as the one clean act, every pick a signed op.
