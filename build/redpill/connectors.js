...
// ⚠ DO NOT REMOVE — REDPILL CONNECTOR SEAM (prompts/RESUME_DISTRIBUTED_BRANCHES.md §isolation).
//   THIS FILE IS THE ONLY COUPLING POINT to the modeller. Everything else in build/redpill/ is
...
//     bus            →  BroadcastChannel('bim_redpill')  (Tier-1 awareness)
'use strict';
...
else (typeof self !== 'undefined' ? self : this).RedpillConnectors = Connectors;
