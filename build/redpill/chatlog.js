...
// ⚠ DO NOT REMOVE — REDPILL CHAT == THE SIGNED LOG (§8). The chat is NOT a side channel: every line
...
'use strict';
var C = (typeof require !== 'undefined') ? require('./connectors') : self.RedpillConnectors;
var E = (typeof require !== 'undefined') ? require('./engine') : self.RedpillEngine;
...
else (typeof self !== 'undefined' ? self : this).RedpillChatlog = L;
