 ...
 * </pre>
 *
 * <p>PK is INTEGER AUTOINCREMENT — BasePO reads back generated key after INSERT.
 */
public class X_AdRoomBoundary extends BasePO {
    ...
    public int    getMinXMm()          { return get_ValueAsInt(COLUMNNAME_min_x_mm); }
    public int    getMaxXMm()          { return get_ValueAsInt(COLUMNNAME_max_x_mm); }
    public int    getMinYMm()          { return get_ValueAsInt(COLUMNNAME_min_y_mm); }
    public int    getMaxYMm()          { return get_ValueAsInt(COLUMNNAME_max_y_mm); }
    ...
    public void setMinXMm(int v)             { set_Value(COLUMNNAME_min_x_mm, v); }
    public void setMaxXMm(int v)             { set_Value(COLUMNNAME_max_x_mm, v); }
    public void setMinYMm(int v)             { set_Value(COLUMNNAME_min_y_mm, v); }
    public void setMaxYMm(int v)             { set_Value(COLUMNNAME_max_y_mm, v); }
