...
// Run: node scripts/poc_redpill_blame.js 2>&1 | tee build/redpill/redpill_blame.log — then READ the log.
'use strict';
var path = require('path');
var E = require(path.join(__dirname, '..', 'build', 'redpill', 'engine.js'));
var fails = 0;
