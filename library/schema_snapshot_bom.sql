...
CREATE TABLE IF NOT EXISTS "m_bom_line" (
    ...
    component_type TEXT DEFAULT NULL, storey         TEXT, element_ref    TEXT, ordinal        INTEGER DEFAULT 0, orientation    TEXT, material_name  TEXT, material_rgba  TEXT, entity_type TEXT DEFAULT 'D', M_BOM_ID INTEGER, verb_ref TEXT DEFAULT NULL, shape_archetype TEXT DEFAULT NULL, scale_band TEXT DEFAULT NULL, host_element_ref TEXT DEFAULT NULL, AD_Org_ID INTEGER DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS C_Order (
    ...
    C_BPartner_ID     INTEGER DEFAULT 0,
