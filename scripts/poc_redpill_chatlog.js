...
//   node-only over build/redpill/ via the stub seam. Read the log after every run.
...
// Run: node scripts/poc_redpill_chatlog.js 2>&1 | tee build/redpill/redpill_chatlog.log — then READ the log.
'use strict';
