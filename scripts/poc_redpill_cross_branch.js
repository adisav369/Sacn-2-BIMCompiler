...
//   (trunk advances). Plus the load-bearing falsifiers. Runs node-only over build/redpill/ through
...
// Run: node scripts/poc_redpill_cross_branch.js 2>&1 | tee build/redpill/redpill_cross_branch.log — then READ the log.
'use strict';
var path = require('path');
var RP = require(path.join(__dirname, '..', 'build', 'redpill', 'index.js'));
