...
M_PRODUCT = [
    ('BACKFLOW_PREVENTER_25MM', 'VALVE', 0.095, 0.125, 0.36, 'IfcFlowController', 'Duplex', None, None, 'IFC_FLOWCONTROLLER', 1),
    ('BALL_VALVE_50MM', 'VALVE', 0.08, 0.139, 0.216, 'IfcFlowController', 'Duplex', None, None, 'IFC_FLOWCONTROLLER', 1),
    ('BATH_TUB_1525', 'FIXTURE', 0.578, 0.76, 1.525, 'IfcFlowTerminal', 'Duplex', None, None, 'IFC_FLOWTERMINAL', 1),
    ('BEAM_W310X60', 'STRUCTURAL', 0.203, 0.303, 7.421, 'IfcBeam', 'Duplex', None, None, 'IFC_BEAM', 1),
    ('BEAM_W410X60', 'STRUCTURAL', 0.407, 1.492, 3.487, 'IfcBeam', 'Duplex', None, None, 'IFC_BEAM', 1),
    ...
    ('Bed_King', 'FURNITURE', 2.032, 1.981, 0.5, None, 'Duplex', 'Textile - White', '0.961,0.961,0.961,1.000', 'IFC_FURNITURE', 1),
    ('Bed_Queen', 'FURNITURE', 1.5, 2.0, 0.5, None, 'Duplex', 'Textile - White', '0.961,0.961,0.961,1.000', 'IFC_FURNITURE', 1),
    ('COFFEE_TABLE_RECT', 'FURNITURE', 0.457, 0.915, 1.83, 'IfcFurnishingElement', 'Duplex', None, None, 'IFC_FURNISHING', 1),
    ('CONDUIT_ELBOW_STEEL', 'CONDUIT', 0.116, 0.136, 0.154, 'IfcFlowSegment', 'Duplex', None, None, 'IFC_FLOWSEGMENT', 1),
    ('CONDUIT_EMT_30MM', 'CONDUIT', 0.03, 0.03, 0.03, 'IfcFlowSegment', 'Duplex', None, None, 'IFC_FLOWSEGMENT', 1),
    ...
    ('COUNTER_TOP_600', 'FURNITURE', 0.142, 0.625, 2.512, 'IfcFurnishingElement', 'Duplex', None, None, 'IFC_FURNISHING', 1),
    ('COUNTER_TOP_SINK_600', 'FURNITURE', 0.142, 0.625, 3.0, 'IfcFurnishingElement', 'Duplex', None, None, 'IFC_FURNISHING', 1),
    ...
    ('DOOR_DUPLEX_ENTRY', 'DOOR', 1.25, 0.467, 2.01, None, 'Duplex', None, None, 'IFC_DOOR', 1),
    ('DOOR_DUPLEX_GLASS', 'DOOR', 0.813, 0.467, 2.42, None, 'Duplex', None, None, 'IFC_DOOR', 1),
    ('DOOR_FLUSH_762', 'DOOR', 0.544, 0.544, 2.108, 'IfcDoor', 'Duplex', None, None, 'IFC_DOOR', 1),
    ('DOOR_FLUSH_864', 'DOOR', 0.455, 0.735, 2.108, 'IfcDoor', 'Duplex', None, None, 'IFC_DOOR', 1),
    ('DOOR_SH_EXT_DBL', 'DOOR', 0.199, 1.86, 2.11, 'IfcDoor', 'SampleHouse', None, None, 'IFC_DOOR', 1),
    ('DOOR_SH_INT_SGL', 'DOOR', 0.178, 0.88, 2.145, 'IfcDoor', 'SampleHouse', None, None, 'IFC_DOOR', 1),
    ('DRAIN_HALFROUND_MY', 'DRAINAGE', 0.23, 1.0, 0.115, None, 'PENDING', None, None, 'IFC_FLOWTERMINAL', 1),
    ('DUCT_ROUND_250MM', 'DUCT', 0.25, 0.25, 0.25, 'IfcFlowSegment', 'Duplex', None, None, 'IFC_FLOWSEGMENT', 1),
    ...
    ('ELEC_OUTLET', 'ELECTRICAL', 0.085, 0.04, 0.085, None, 'Duplex', None, None, 'IFC_LIGHTFIXTURE', 1),
    ('ELEC_SWITCH', 'ELECTRICAL', 0.085, 0.04, 0.085, None, 'Duplex', None, None, 'IFC_LIGHTFIXTURE', 1),
    ('FIRE_ALARM_PANEL', 'FP', 0.138, 0.4, 0.475, 'IfcFlowTerminal', 'Duplex', None, None, 'IFC_FLOWTERMINAL', 1),
    ('FITTING_BEND_PVC_DWV', 'FITTING', 0.066, 0.072, 0.077, 'IfcFlowFitting', 'Duplex', None, None, 'IFC_FLOWFITTING', 1),
    ('FITTING_ELBOW_GENERIC', 'FITTING', 0.033, 0.033, 0.034, 'IfcFlowFitting', 'Duplex', None, None, 'IFC_FLOWFITTING', 1),
    ('FITTING_RECT_ROUND_45', 'FITTING', 0.063, 0.25, 0.25, 'IfcFlowFitting', 'Duplex', None, None, 'IFC_FLOWFITTING', 1),
    ('FITTING_ROOF_DRAIN_380', 'FITTING', 0.3, 0.3, 0.585, 'IfcFlowFitting', 'Duplex', None, None, 'IFC_FLOWFITTING', 1),
    ('FITTING_TEE_GENERIC', 'FITTING', 0.045, 0.048, 0.059, 'IfcFlowFitting', 'Duplex', None, None, 'IFC_FLOWFITTING', 1),
    ('FITTING_TRANSITION_GENERIC', 'FITTING', 0.025, 0.03, 0.033, 'IfcFlowFitting', 'Duplex', None, None, 'IFC_FLOWFITTING', 1),
    ('FIXTURE_SHOWER', 'FIXTURE', 0.9, 0.9, 2.1, 'IfcFlowTerminal', 'Duplex', 'Ceramic', '0.950,0.950,0.950,1.000', 'IFC_FLOWTERMINAL', 1),
    ('FIXTURE_SINK', 'FIXTURE', 0.5, 0.45, 0.2, 'IfcFlowTerminal', 'EXTRACTED', 'Ceramic', '0.950,0.950,0.950,1.000', 'IFC_FLOWTERMINAL', 1),
    ('FIXTURE_TOILET', 'FIXTURE', 0.4, 0.7, 0.4, 'IfcFlowTerminal', 'Duplex', 'Ceramic', '0.950,0.950,0.950,1.000', 'IFC_FLOWTERMINAL', 1),
    ...
    ('FP_SMOKE', 'FP', 0.12, 0.12, 0.05, None, 'Duplex', None, None, 'IFC_FIRESUPPTERM', 1),
    ('FP_SPRINKLER', 'FP', 0.1, 0.1, 0.15, None, 'EXTRACTED', None, None, 'IFC_FIRESUPPTERM', 1),
    ('FURN_ARMCHAIR_VIPER', 'FURNITURE', 1.426, 1.395, 0.918, 'IfcFurnishingElement', 'SampleHouse', None, None, 'IFC_FURNISHING', 1),
    ...
    ('FURN_KITCHEN_BASE', 'FURNITURE', 1.0, 0.625, 0.86, None, 'Duplex', 'Laminate, Ivory, Matte', '1.000,1.000,0.941,1.000', 'IFC_FURNITURE', 1),
    ...
    ('LAVATORY_OVAL_535', 'FIXTURE', 0.228, 0.485, 0.535, 'IfcFlowTerminal', 'Duplex', None, None, 'IFC_FLOWTERMINAL', 1),
    ('LAVATORY_OVAL_650', 'FIXTURE', 0.228, 0.485, 0.65, 'IfcFlowTerminal', 'Duplex', None, None, 'IFC_FLOWTERMINAL', 1),
    ('LIFT_LOBBY', 'PHANTOM', 0.001, 0.001, 0.001, None, 'PHANTOM', None, None, 'ASM_PHANTOM', 0),
    ('LIGHT_PENDANT_150W', 'ELECTRICAL', 0.506, 0.507, 0.675, 'IfcFlowTerminal', 'Duplex', None, None, 'IFC_FLOWTERMINAL', 1),
    ('LIGHT_SCONCE_100W', 'ELECTRICAL', 0.2, 0.397, 0.4, 'IfcFlowTerminal', 'Duplex', None, None, 'IFC_FLOWTERMINAL', 1),
    ('LIVING_SET', 'SET', 0.001, 0.001, 0.001, None, 'BOM_ASSEMBLY', None, None, 'ASM_SET', 0),
    ('MEMBER_SH_CURTAIN_WALL', 'STRUCTURAL', 0.499, 0.581, 1.226, 'IfcMember', 'SampleHouse', None, None, 'IFC_MEMBER', 1),
    ('MICROWAVE', 'APPLIANCE', 0.399, 0.45, 0.76, 'IfcFlowTerminal', 'Duplex', None, None, 'IFC_FLOWTERMINAL', 1),
    ('PANELBOARD_208V_400A', 'ELECTRICAL', 0.146, 0.508, 1.27, 'IfcFlowTerminal', 'Duplex', None, None, 'IFC_FLOWTERMINAL', 1),
    ('PIPE_COLD_WATER_13MM', 'PIPE', 0.013, 0.013, 0.013, 'IfcFlowSegment', 'Duplex', None, None, 'IFC_FLOWSEGMENT', 1),
    ('PIPE_COLD_WATER_25MM', 'PIPE', 0.025, 0.025, 0.025, 'IfcFlowSegment', 'Duplex', None, None, 'IFC_FLOWSEGMENT', 1),
    ('PIPE_HOT_WATER_13MM', 'PIPE', 0.013, 0.013, 0.013, 'IfcFlowSegment', 'Duplex', None, None, 'IFC_FLOWSEGMENT', 1),
    ('PIPE_HOT_WATER_25MM', 'PIPE', 0.025, 0.025, 0.025, 'IfcFlowSegment', 'Duplex', None, None, 'IFC_FLOWSEGMENT', 1),
    ('PIPE_MECHANICAL_33MM', 'PIPE', 0.033, 0.033, 0.033, 'IfcFlowSegment', 'Duplex', None, None, 'IFC_FLOWSEGMENT', 1),
    ('PIPE_PVC_33MM', 'PIPE', 0.033, 0.033, 0.033, 'IfcFlowSegment', 'Duplex', None, None, 'IFC_FLOWSEGMENT', 1),
    ('PIPE_WASTE_33MM', 'PIPE', 0.033, 0.033, 0.033, 'IfcFlowSegment', 'Duplex', None, None, 'IFC_FLOWSEGMENT', 1),
    ('PIPE_WASTE_48MM', 'PIPE', 0.048, 0.048, 0.048, 'IfcFlowSegment', 'Duplex', None, None, 'IFC_FLOWSEGMENT', 1),
    ('PLATE_SH_GLAZED', 'STRUCTURAL', 0.829, 0.955, 3.027, 'IfcPlate', 'SampleHouse', None, None, 'IFC_PLATE', 1),
    ('Piano', 'FURNITURE', 1.371, 0.6, 1.17, 'IfcFurniture', 'EXTRACTED', 'Wood - Mahogany', '0.600,0.400,0.200,1.000', 'IFC_FURNITURE', 1),
    ('RAILING_GUARD_1100', 'STRUCTURAL', 0.09, 3.805, 3.952, 'IfcRailing', 'Duplex', None, None, 'IFC_RAILING', 1),
    ('RAILING_HANDRAIL_900', 'STRUCTURAL', 0.04, 2.957, 3.75, 'IfcRailing', 'Duplex', None, None, 'IFC_RAILING', 1),
    ('RANGE', 'APPLIANCE', 0.663, 0.76, 1.041, 'IfcFlowTerminal', 'Duplex', None, None, 'IFC_FLOWTERMINAL', 1),
    ('REFRIGERATOR', 'APPLIANCE', 0.804, 0.85, 1.83, 'IfcFlowTerminal', 'Duplex', None, None, 'IFC_FLOWTERMINAL', 1),
    ...
    ('ROOF_SH_FLAT_4FELT', 'STRUCTURAL', 1.734, 14.841, 7.285, 'IfcRoof', 'SampleHouse', None, None, 'IFC_ROOF', 1),
    ...
    ('SINK_ISLAND', 'FIXTURE', 0.455, 0.457, 0.486, 'IfcFlowTerminal', 'Duplex', None, None, 'IFC_FLOWTERMINAL', 1),
    ('SKYLIGHT_1180', 'WINDOW', 0.178, 1.173, 1.225, 'IfcWindow', 'Duplex', None, None, 'IFC_WINDOW', 1),
    ('SLAB_FINISH_CERAMIC', 'SLAB', 0.013, 1.0, 1.0, 'IfcSlab', 'Duplex', None, None, 'IFC_SLAB', 1),
    ('SLAB_FINISH_WOOD', 'SLAB', 0.019, 1.0, 1.0, 'IfcSlab', 'Duplex', None, None, 'IFC_SLAB', 1),
    ('SLAB_GRADE_127', 'SLAB', 0.127, 1.0, 1.0, 'IfcSlab', 'Duplex', None, None, 'IFC_SLAB', 1),
    ('SLAB_GRADE_150', 'SLAB', 0.15, 1.0, 1.0, 'IfcSlab', 'Duplex', None, None, 'IFC_SLAB', 1),
    ('SLAB_ROOF_LIVE', 'SLAB', 0.457, 1.0, 1.0, 'IfcSlab', 'Duplex', None, None, 'IFC_SLAB', 1),
    ('SLAB_SH_GROUND_SUSP', 'SLAB', 0.47, 16.868, 8.668, 'IfcSlab', 'SampleHouse', None, None, 'IFC_SLAB', 1),
    ('SLAB_SH_SIMPLE', 'SLAB', 0.165, 13.968, 5.768, 'IfcSlab', 'SampleHouse', None, None, 'IFC_SLAB', 1),
    ('SLAB_WOOD_JOIST', 'SLAB', 0.305, 1.0, 1.0, 'IfcSlab', 'Duplex', None, None, 'IFC_SLAB', 1),
    ('SOFA_1830', 'FURNITURE', 0.813, 1.245, 1.245, 'IfcFurnishingElement', 'Duplex', None, None, 'IFC_FURNISHING', 1),
    ...
    ('STAIR_FLIGHT', 'STRUCTURAL', 0.914, 3.772, 3.05, 'IfcStairFlight', 'Duplex', None, None, 'IFC_STAIRFLIGHT', 1),
    ('STAIR_STRINGER', 'STRUCTURAL', 0.05, 3.1, 3.75, 'IfcMember', 'Duplex', None, None, 'IFC_MEMBER', 1),
    ('Side_Table', 'FURNITURE', 0.5, 0.5, 0.6, None, 'EXTRACTED', 'Wood - Birch', '0.871,0.722,0.529,1.000', 'IFC_FURNITURE', 1),
    ('Side_Table_Cube_610', 'FURNITURE', 0.61, 0.61, 0.61, 'IfcFurniture', 'Duplex', 'Wood - Birch', '0.871,0.722,0.529,1.000', 'IFC_FURNITURE', 1),
    ...
    ('TALL_CABINET_800', 'FURNITURE', 0.545, 0.8, 2.0, 'IfcFurnishingElement', 'Duplex', None, None, 'IFC_FURNISHING', 1),
    ('TELEPHONE_BOARD', 'ELECTRICAL', 0.044, 0.3, 0.3, 'IfcFlowTerminal', 'Duplex', None, None, 'IFC_FLOWTERMINAL', 1),
    ('TELEPHONE_OUTLET', 'ELECTRICAL', 0.064, 0.064, 0.114, 'IfcFlowTerminal', 'Duplex', None, None, 'IFC_FLOWTERMINAL', 1),
    ...
    ('UPPER_CABINET_1000', 'FURNITURE', 0.345, 0.6, 1.0, 'IfcFurnishingElement', 'Duplex', None, None, 'IFC_FURNISHING', 1),
    ('Upper_Cabinet', 'FURNITURE', 0.6, 0.35, 0.9, 'IfcFurniture', 'EXTRACTED', 'Wood - Birch', '0.871,0.722,0.529,1.000', 'IFC_FURNITURE', 1),
    ('VANITY_CABINET_450', 'FURNITURE', 0.45, 0.475, 0.82, 'IfcFurnishingElement', 'Duplex', None, None, 'IFC_FURNISHING', 1),
    ('VANITY_CABINET_650', 'FURNITURE', 0.475, 0.65, 0.82, 'IfcFurnishingElement', 'Duplex', None, None, 'IFC_FURNISHING', 1),
    ...
    ('WALL_EXT_BRICK_BLOCK', 'WALL', 0.417, 1.0, 1.0, 'IfcWall', 'Duplex', None, None, 'IFC_WALL', 1),
    ...
    ('WALL_FOUNDATION_417', 'WALL', 0.417, 1.0, 1.0, 'IfcWall', 'Duplex', None, None, 'IFC_WALL', 1),
    ('WALL_FOUNDATION_435', 'WALL', 0.435, 1.0, 1.0, 'IfcWall', 'Duplex', None, None, 'IFC_WALL', 1),
    ('WALL_INT_FURRING_152', 'WALL', 0.152, 1.0, 1.0, 'IfcWall', 'Duplex', None, None, 'IFC_WALL', 1),
    ('WALL_INT_FURRING_38', 'WALL', 0.054, 1.0, 1.0, 'IfcWall', 'Duplex', None, None, 'IFC_WALL', 1),
    ('WALL_INT_PARTITION_92', 'WALL', 0.124, 1.0, 1.0, 'IfcWall', 'Duplex', None, None, 'IFC_WALL', 1),
    ('WALL_INT_PLUMBING_152', 'WALL', 0.184, 1.0, 1.0, 'IfcWall', 'Duplex', None, None, 'IFC_WALL', 1),
    ('WALL_PARTY_CMU', 'WALL', 0.493, 1.0, 1.0, 'IfcWall', 'Duplex', None, None, 'IFC_WALL', 1),
    ('WALL_SH_EXT_102BWK', 'WALL', 0.289, 7.797, 2.884, 'IfcWall', 'SampleHouse', None, None, 'IFC_WALL', 1),
    ('WALL_SH_PARTN_70M', 'WALL', 0.094, 2.274, 2.335, 'IfcWall', 'SampleHouse', None, None, 'IFC_WALL', 1),
    ...
    ('WINDOW_CASEMENT_819', 'WINDOW', 0.618, 0.618, 0.759, 'IfcWindow', 'Duplex', None, None, 'IFC_WINDOW', 1),
    ('WINDOW_DUPLEX_BEDROOM', 'WINDOW', 2.8, 0.417, 2.41, None, 'Duplex', None, None, 'IFC_WINDOW', 1),
    ('WINDOW_DUPLEX_LIVING', 'WINDOW', 4.835, 0.417, 2.42, None, 'Duplex', None, None, 'IFC_WINDOW', 1),
    ('WINDOW_DUPLEX_SMALL', 'WINDOW', 0.819, 0.417, 0.759, None, 'Duplex', None, None, 'IFC_WINDOW', 1),
    ('WINDOW_FIXED_750x2200', 'WINDOW', 0.417, 0.75, 2.2, 'IfcWindow', 'Duplex', None, None, 'IFC_WINDOW', 1),
    ('WINDOW_SH_1810x1210', 'WINDOW', 0.353, 1.86, 1.21, 'IfcWindow', 'SampleHouse', None, None, 'IFC_WINDOW', 1),
