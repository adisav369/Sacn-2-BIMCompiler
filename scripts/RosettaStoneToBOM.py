...
M_BOM_LINE = [
    ...
    ('BATHROOM_PREFAB_MY', 'TOILET_BLOCK_FIXTURES', 'MAKE', 'SANITARY', 10, 'FACE_AWAY_FROM_WALL', 10, 1200, 0.0, 0.0, 0.3, 1, 'D', 0, 0, 0),
    ...
    ('BEDROOM_PREFAB_MY_3100', 'WALL_EXT_MY_150_WIN_STD', 'MAKE', 'WALL_EXT', 10, 'FACE_OUTSIDE', 10, 0, 0.0, 0.0, 0.3, 1, 'D', 1200, 100, 1200),
    ('BEDROOM_PREFAB_MY_3100', 'DOOR_D2', 'BUY', 'DOOR_ENTRY', 20, 'FACE_INTO_ROOM', 10, 0, 0.4, 0.0, 0.3, 1, 'D', 800, 45, 2100),
    ('BEDROOM_PREFAB_MY_3100', 'BED_SET_MASTER', 'MAKE', 'FURNITURE', 30, 'FACE_AWAY_FROM_WALL', 20, 2000, 0.0, 0.0, 0.3, 1, 'D', 1820, 600, 2000),
    ...
    ('DUPLEX_SET_STD', 'DUPLEX_SINGLE_UNIT_STD', 'MAKE', 'UNIT_A', 10, '0', 20, 0, 0.0, 0.0, 0.0, 1, 'D', 0, 0, 0),
    ('DUPLEX_SET_STD', 'DUPLEX_SINGLE_UNIT_STD', 'MAKE', 'UNIT_B', 20, '3.14159265358979', 20, 0, 0.0, 0.0, 0.0, 1, 'D', 0, 0, 0),
    ('DUPLEX_SINGLE_UNIT_STD', 'LIVING_SET', 'MAKE', 'LIVING', 10, '0', 20, 0, 0.0, 0.0, 0.0, 1, 'D', 4871, 1400, 1170),
    ('DUPLEX_SINGLE_UNIT_STD', 'DINING_SET', 'MAKE', 'DINING', 20, '0', 20, 0, 0.0, 0.0, 0.0, 1, 'D', 1950, 2450, 750),
    ('DUPLEX_SINGLE_UNIT_STD', 'KITCHEN_CABINET_SET', 'MAKE', 'KITCHEN_GF', 30, '0', 20, 0, 0.0, 0.0, 0.0, 1, 'D', 1500, 600, 1900),
    ('DUPLEX_SINGLE_UNIT_STD', 'DUPLEX_BATHROOM_SET', 'MAKE', 'BATHROOM_GF', 40, '0', 20, 0, 0.0, 0.0, 0.0, 1, 'D', 0, 0, 0),
    ('DUPLEX_SINGLE_UNIT_STD', 'BED_SET', 'MAKE', 'BEDROOM', 50, '0', 20, 0, 0.0, 0.0, 0.0, 1, 'D', 3000, 600, 2000),
    ('DUPLEX_SINGLE_UNIT_STD', 'BED_SET_MASTER', 'MAKE', 'MASTER', 60, '0', 20, 0, 0.0, 0.0, 0.0, 1, 'D', 1820, 600, 2000),
    ('DUPLEX_SINGLE_UNIT_STD', 'WARDROBE_SET', 'MAKE', 'WARDROBE', 70, '0', 20, 0, 0.0, 0.0, 0.0, 1, 'D', 2400, 600, 2100),
    ('DUPLEX_SINGLE_UNIT_STD', 'DUPLEX_BATHROOM_SET', 'MAKE', 'BATHROOM_UF', 80, '0', 20, 0, 0.0, 0.0, 0.0, 1, 'D', 0, 0, 0),
    ('DUPLEX_SINGLE_UNIT_STD', 'KITCHEN_CABINET_SET', 'MAKE', 'KITCHEN_UF', 90, '0', 20, 0, 0.0, 0.0, 0.0, 1, 'D', 1500, 600, 1900),
    ('FLOOR_DX_L1_STD', 'LIVING_SET', 'MAKE', 'LIVING', 10, '0', 20, 0, 0.0, 0.0, 0.0, 0, 'D', 4871, 1400, 1170),
    ('FLOOR_DX_L1_STD', 'DINING_SET', 'MAKE', 'DINING', 20, '0', 20, 0, 0.0, 0.0, 0.0, 1, 'D', 1950, 2450, 750),
    ('FLOOR_DX_L1_STD', 'KITCHEN_CABINET_SET', 'MAKE', 'KITCHEN', 30, '0', 20, 0, 0.0, 0.0, 0.0, 0, 'D', 1500, 600, 1900),
    ('FLOOR_DX_L1_STD', 'KITCHEN_CABINET_SET_DX_A', 'MAKE', 'KITCHEN_A', 32, '0', 20, 0, 0.0, 0.0, 0.0, 1, 'D', 0, 0, 0),
    ('FLOOR_DX_L1_STD', 'KITCHEN_CABINET_SET_DX_B', 'MAKE', 'KITCHEN_B', 34, '0', 20, 0, 0.0, 0.0, 0.0, 1, 'D', 0, 0, 0),
    ('FLOOR_DX_L1_STD', 'TOILET_BLOCK_FIXTURES', 'MAKE', 'BATHROOM', 40, '0', 20, 0, 0.0, 0.0, 0.0, 1, 'D', 0, 0, 0),
    ('FLOOR_DX_L2_STD', 'BED_SET', 'MAKE', 'BEDROOM', 10, '0', 20, 0, 0.0, 0.0, 0.0, 0, 'D', 3000, 600, 2000),
    ('FLOOR_DX_L2_STD', 'BED_SET_MASTER', 'MAKE', 'MASTER', 20, '0', 20, 0, 0.0, 0.0, 0.0, 0, 'D', 1820, 600, 2000),
    ('FLOOR_DX_L2_STD', 'WARDROBE_SET', 'MAKE', 'WARDROBE', 30, '0', 20, 0, 0.0, 0.0, 0.0, 1, 'D', 2400, 600, 2100),
    ('FLOOR_DX_L2_STD', 'TOILET_BLOCK_FIXTURES', 'MAKE', 'BATHROOM', 40, '0', 20, 0, 0.0, 0.0, 0.0, 1, 'D', 0, 0, 0),
    ('FLOOR_DX_L2_STD', 'KITCHEN_CABINET_SET', 'MAKE', 'KITCHEN', 50, '0', 20, 0, 0.0, 0.0, 0.0, 1, 'D', 1500, 600, 1900),
    ('FLOOR_SH_GF_STD', 'SH_LIVING_SET', 'MAKE', 'LIVING', 10, '0', 20, 0, 0.0, 0.0, 0.0, 1, 'D', 9069, 1682, 1170),
    ('FLOOR_SH_GF_STD', 'SH_DINING_SET', 'MAKE', 'DINING', 20, '0', 20, 0, 0.0, 0.0, 0.0, 1, 'D', 2504, 1463, 750),
    ('FLOOR_SH_GF_STD', 'SH_BED_SET', 'MAKE', 'MASTER', 30, '0', 20, 0, 0.0, 0.0, 0.0, 1, 'D', 2078, 2264, 600),
    ('FLOOR_SH_GF_STD', 'TOILET_BLOCK_FIXTURES', 'MAKE', 'BATHROOM', 40, '0', 20, 0, 0.0, 0.0, 0.0, 1, 'D', 0, 0, 0),
    ...
    ('FLOOR_TBLKTN_GF_STD', 'LIVING_SET', 'MAKE', 'LIVING', 10, '0', 20, 0, 0.0, 0.0, 0.0, 1, 'D', 4871, 1400, 1170),
    ('FLOOR_TBLKTN_GF_STD', 'DINING_SET', 'MAKE', 'DINING', 20, '0', 20, 0, 0.0, 0.0, 0.0, 1, 'D', 1950, 2450, 750),
    ('FLOOR_TBLKTN_GF_STD', 'KITCHEN_CABINET_SET', 'MAKE', 'KITCHEN', 30, '0', 20, 0, 0.0, 0.0, 0.0, 1, 'D', 1500, 600, 1900),
    ('FLOOR_TBLKTN_GF_STD', 'BED_SET', 'MAKE', 'BEDROOM', 40, '0', 20, 0, 0.0, 0.0, 0.0, 1, 'D', 3000, 600, 2000),
    ('FLOOR_TBLKTN_GF_STD', 'BED_SET_MASTER', 'MAKE', 'MASTER', 50, '0', 20, 0, 0.0, 0.0, 0.0, 1, 'D', 1820, 600, 2000),
    ('FLOOR_TBLKTN_GF_STD', 'TOILET_BLOCK_FIXTURES', 'MAKE', 'BATHROOM', 60, '0', 20, 0, 0.0, 0.0, 0.0, 1, 'D', 0, 0, 0),
    ...
    ('KITCHEN_PREFAB_MY', 'WALL_EXT_MY_150_WIN_STD', 'MAKE', 'WALL_EXT', 10, 'FACE_OUTSIDE', 10, 0, 0.0, 0.0, 0.0, 1, 'D', 0, 0, 0),
    ('KITCHEN_PREFAB_MY', 'KITCHEN_CABINET_SET', 'MAKE', 'FURNITURE', 20, 'FACE_AWAY_FROM_WALL', 20, 600, 0.0, 0.0, 0.0, 1, 'D', 0, 0, 0),
    ('KITCHEN_PREFAB_MY', 'ELEC_LIGHT', 'BUY', 'LIGHT', 30, '0', 30, 0, 1.8, 1.65, -0.3, 1, 'D', 0, 0, 0),
    ('LIVING_PREFAB_MY', 'WALL_EXT_MY_150_WIN_STD', 'MAKE', 'WALL_EXT', 10, 'FACE_OUTSIDE', 10, 0, 0.0, 0.0, 0.3, 1, 'D', 1200, 100, 1200),
    ('LIVING_PREFAB_MY', 'LIVING_SET', 'MAKE', 'FURNITURE', 20, 'FACE_AWAY_FROM_WALL', 20, 3000, 0.0, 0.0, 0.3, 1, 'D', 4871, 1400, 1170),
    ...
    ('PORCH_MODULE_MY', 'WALL_EXT_MY_150_SOLID', 'MAKE', 'WALL_SOUTH', 10, 'FACE_OUTSIDE', 10, 0, 0.0, 0.0, 0.3, 1, 'D', 0, 0, 0),
    ...
    ('ROOF_ASSEMBLY', 'ROOF_STRUCTURE', 'MAKE', 'STRUCTURE', 10, '0', 20, 0, 0.0, 0.0, 0.0, 1, 'D', 0, 0, 0),
    ('ROOF_ASSEMBLY', 'ROOF_COVERING', 'MAKE', 'COVERING', 20, '0', 20, 0, 0.0, 0.0, 0.0, 1, 'D', 0, 0, 0),
    ('ROOM_FURNITURE', 'WORKSTATION_SET', 'MAKE', 'WORK_ZONE', 1, '0', 20, 0, 0.0, 0.0, 0.0, 1, 'D', 0, 0, 0),
    ('ROOM_FURNITURE', 'VISITOR_SET', 'MAKE', 'VISITOR_ZONE', 2, '0', 20, 0, 0.0, 0.0, 0.0, 0, 'D', 0, 0, 0),
    ...
    ('SH_LIVING_SET', 'SOFA_AREA', 'MAKE', 'SOFA', 30, '0', 20, 0, 5.301, 0.278, 0.0, 1, 'D', 2287, 977, 958),
    ...
    ('SPRINKLER_PENDANT_ASSEMBLY', 'T_CONNECTOR_ASSEMBLY', 'MAKE', 'T_ASSEMBLY', 2, '0', 20, 0, 0.0, 0.0, 0.0, 1, 'D', 0, 0, 0),
    ...
    ('TYPICAL_CONDO_FLOOR', 'CORE_ASSEMBLY', 'MAKE', 'CORE', 1, '0', 20, 0, 0.0, 0.0, 0.0, 1, 'D', 0, 0, 0),
    ...
    ('WALL_PANEL', 'DOOR_ASSEMBLY', 'MAKE', 'OPENING', 30, '0', 20, 0, 0.0, 0.0, 0.0, 1, 'D', 0, 0, 0),
