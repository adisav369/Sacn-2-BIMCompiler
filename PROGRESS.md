...
**[DONE] Session C** (2026-03-24): Rule pack framing. pack_id column on 4 AD tables (DV016 migration). Jurisdiction→pack mapping: MY=[BASE,UBBL-2024,NFPA-13], US=[BASE,IBC-2021,NFPA-13]. propose() takes packIds with backward-compatible default. MY=13 proposals, US=17 proposals on SH — different building codes. W-RULEPACK-1: RulePackTest 6/6. Existing tests 8/8 + 4/4. Full gate GREEN.
...
**S67c** — Session C: Rule pack framing. (1) DV016 migration: pack_id TEXT on ad_space_type_mep_bom (BASE=97, UBBL-2024=34, IBC-2021=45, NFPA-13=10), ad_fp_trigger, ad_fp_coverage, ad_code_requirement. (2) OrderLineMutation: packsForJurisdiction() mapping + propose(woConn, ruleDb, orderId, packIds) with backward-compatible default. (3) MEPBOMQuery: pack_id IN filter. (4) 3 Suggestions updated to pass packIds. (5) RulePackTest 6/6 GREEN. W-RULEPACK-1: MY=13, US=17 proposals — different building codes. OrderLineMutationTest 8/8, AddDisciplineTest 4/4 backward compat. Full gate GREEN. AUDIT Appendix M.
