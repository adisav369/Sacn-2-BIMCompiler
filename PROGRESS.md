...
**GLASSBOWL — engine-as-data explorer (2026-05-30): LIVE read-only MVP + interactive.** (spec: `docs/GLASSBOWL.md`; Phase 2 spec: `docs/GLASSBOWL_DOSSIER.md`)
  ...
  - **NEXT:** Phase 2b floating card + **per-bubble action array** (left=focus+log+trace done, right=dossier/edit, double=expand); 2c DOSSIER; undo/redo greying reversed bars (T3/editing). Editing T3-gated (LAST).
