...
**GLASSBOWL — engine-as-data explorer (2026-05-30): LIVE read-only MVP + interactive.** (spec: `docs/GLASSBOWL.md`; Phase 2 spec: `docs/GLASSBOWL_DOSSIER.md`)
  ...
  - **NEXT:** Phase 2b floating card + the **per-bubble action array** (left=focus+log done, right=dossier/edit, double=expand/trace); then 2c DOSSIER. Editing T3-gated (LAST). All staged to `docs/` (glassbowl.html + glassbowl_data.db + sqljs/) — NOT yet `mkdocs gh-deploy`'d (awaiting go).
