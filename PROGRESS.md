...
- ✅ Blank Viewer landing card + local `.db` Open — CLOSED + user-confirmed live (07-27/28), bim-compiler
  `40e333efd`, bim-ootb PRs #1068+#1070. Detail `Viewer/BLANK_VIEWER_LANDING_CARD.md`; standing lesson
  `feedback_bimootb_sw_cache_bump_on_viewer_change.md`. 🟢 unresolved, non-blocking: an idempiere-seed-db
