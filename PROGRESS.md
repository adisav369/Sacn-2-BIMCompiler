...
- `ROOM_LENS_VISUAL_HIGHLIGHT_SPEC.md` §25/§14 · `PHOTOREAL_STILL_RENDER.md` §CINEMA_ORBIT_V2 #931/#933,
  ⛔ §MAXQ_SURFACELESS_FRAMEBUFFER (LTU "building disappears", distinct from #1011, spec only) —
  **DOWNGRADED: unattended LTU Alt+C ran 360/360 clean, 19m24s, zero GL errors** → attended-only,
  visibility-heuristic lead first; +2 minor log finds (patch-probe 404s ×2, deprecated PWA meta).
