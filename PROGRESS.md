...
**S104 IFCtoERP (`365fc163`, `abdcd045`):**
  ...
  Next: `prompts/00r_route_walker_impl.txt` — RouteWalker class (DAGCompiler): pattern select + anchor match + c_orderline emit.
        `prompts/00s_pattern_witness_gates.txt` — W-PATTERN-CW + W-PATTERN-SP gate tests (RouteWalkerTest 7 assertions).
